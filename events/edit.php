...
<html>
	...
	<body>
		...
		<div class="container event_add-wrapper">
			...
			<form action="../auth/event_edit.php" method="POST">
				<div class="form group">
					...
					<div class="col-lg-5 col-md-5 col-lg-offset-3 col-md-offset-3">
						<label>規則</label>
						<input type="text" name="rule" class="form-control" placeholder="Rule" value=<?php echo $rule; ?>>
						<br>
					</div>
					<div class="col-lg-5 col-md-5 col-lg-offset-3 col-md-offset-3">
						<label>隊伍限制</label>
						<input type="number" name="team_limit" class="form-control" placeholder="Team Number Limit" value=<?php echo $team_limit; ?>>
						<br>
					</div>
					<div class="col-lg-5 col-md-5 col-lg-offset-3 col-md-offset-3">
						<label>每隊人數限制</label>
						<input type="number" name="member_limit" class="form-control" placeholder="Member Number Limit" value=<?php echo $member_limit; ?>>
						<br>
					</div>
					<div class="row">
